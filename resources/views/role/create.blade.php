        ...
        <div class="section-body">
        	<div class="row">
              <div class="col-12">
                <div class="card">
                  <div class="card-body">
                    <form method="POST" action="{{ route('role/create') }}" id="roleForm" name="roleForm">
                      @csrf
                        ...
                        <div class="row col-sm-12">
                          @foreach ($permissions as $key => $value)
                            ...
                            <div class="custom-control custom-checkbox col-sm-3">
                              <input type="checkbox" name="permission[]" class="custom-control-input" id="{{ $value }}" value="{{ $value }}">
